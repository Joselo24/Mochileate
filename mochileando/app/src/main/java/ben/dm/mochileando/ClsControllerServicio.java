...
/**
 * Created by Benito on 31/07/2015.
 */
public class ClsControllerServicio {
    ...
    JSONArray jarViajeMatrix = null;
    JSONObject jobViajeMatrix = null;
    JSONArray jar_x_ViajeMatrix = null;
    JSONObject job_x_ViajeMatrix = null;

    //Variables contenedoras
    ArrayList<HashMap<String, String>> has_x_Viajar, hasViaje;
    private static String url= "http://www.studioqatro.com/mochileando/AllInfo.php";
    private static String url2= "http://www.studioqatro.com/mochileando/AllAnfitriones.php";
    ...
    ClsControllerServicio(){    }
    ClsControllerServicio(List params, boolean key){

        codViaje  =new String[25];

        hasViaje = new ArrayList<HashMap<String, String>>();
        try {
            ...
            switch (success){
                ...
                case 1:
                    ...
                    jarViajeMatrix = jsonPerfil.getJSONArray(TAG_VIAJES);
                    Log.d("viaje ", jarViajeMatrix.toString());
                    for (int i = 0; i < jarViajeMatrix.length(); i++) {
                        jobViajeMatrix = jarViajeMatrix.getJSONObject(i);

                        codViaje[i] = jobViajeMatrix.getString(TAG_cod_anfitrion_v);
                        String cod_anfitrion_v = jobViajeMatrix.getString(TAG_cod_anfitrion_v);
                        String provincia_v = jobViajeMatrix.getString(TAG_provincia_v);
                        String nombres_v = jobViajeMatrix.getString(TAG_nombres_v);
                        String direccion_v = jobViajeMatrix.getString(TAG_direccion_v);
    ...
    ClsControllerServicio(List params){
                ...
                switch (success){
                    ...
                    case 1:
                        ...
                        for (int i = 0; i < jarViajeMatrix.length(); i++) {
                            ...
                            String nombres_v = jobViajeMatrix.getString(TAG_nombres_v);
                            String direccion_v = jobViajeMatrix.getString(TAG_direccion_v);
                            String fecha_v = jobViajeMatrix.getString(TAG_fecha_v);
                            HashMap map1 = new HashMap();
                            //map.put(TAG_cod_anfitrion_v, cod_anfitrion_v);
                            map1.put(TAG_provincia_v, provincia_v);
                            map1.put(TAG_nombres_v, nombres_v);
                        ...
                        jar_x_ViajeMatrix = jsonPerfil.getJSONArray(TAG_XVIAJAR);
                        Log.d("xviaje ", jar_x_ViajeMatrix.toString());
                        for (int i = 0; i < jar_x_ViajeMatrix.length(); i++) {
                            job_x_ViajeMatrix = jar_x_ViajeMatrix.getJSONObject(i);

                            cod_x_Viajar[i] = job_x_ViajeMatrix.getString(TAG_cod_anfitrion_xv);
                            String cod_anfitrion_xv = job_x_ViajeMatrix.getString(TAG_cod_anfitrion_xv);
                            String provincia_xv = job_x_ViajeMatrix.getString(TAG_provincia_xv);
                            String nombres_xv = job_x_ViajeMatrix.getString(TAG_nombres_xv);
                            String direccion_xv = job_x_ViajeMatrix.getString(TAG_direccion_xv);
                            String fecha_xv = job_x_ViajeMatrix.getString(TAG_fecha_xv);
                            String estadoViaje_xv = job_x_ViajeMatrix.getString(TAG_estadoViaje_xv);
    ...
    public int actualizarPerfil(List params){
        try {
            String url="http://www.studioqatro.com/easy_tecnico/T_Tecnico_ActualizarPerfil.php";
    ...
    public int actualizarHorario(List params){
        try {
            String url="http://www.studioqatro.com/easy_tecnico/T_Tecnico_ActualizarHorarioL.php";
    ...
    public ArrayList<HashMap<String, String>> getHas_x_Viajar(){
           return has_x_Viajar;
    }

    public ArrayList<HashMap<String, String>> getHasViaje(){
        return hasViaje;
    }
